...
- (void)viewDidLoad {
    ...
    [_disCtl.searchResultsTableView registerNib:[UINib nibWithNibName:@"CustomCell" bundle:nil] forCellReuseIdentifier:@"myCell"];
...
-(void)loadData{
    ...
    for (int i = 0; i<3; i++) {
        ...
        for (int j = 0; j <3 ; j++) {
            ...
            perModel.markStr = [NSString stringWithFormat:@"心情%d",3*i+j+1];
